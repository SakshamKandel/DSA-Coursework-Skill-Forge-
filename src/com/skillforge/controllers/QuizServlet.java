...
/**
 * Shows the quiz for a course and saves the student's submission.
 * On a passing score the servlet also issues a certificate before redirecting
 * the student to the result page.
 */
...
public class QuizServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            // Count how many questions the student answered correctly
            int correctCount = 0;
            ...
            // Issue a certificate only when the student passes the quiz
            if (passed) {
