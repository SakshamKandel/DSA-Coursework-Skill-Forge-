...
<div class="px-10 py-20 flex flex-col items-center text-center">
    <div class="max-w-2xl w-full bg-white rounded-[3rem] p-16 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100">
        ...
        <% if (passed) { %>
            ...
            <h2 class="text-4xl font-black text-slate-800 mb-4 tracking-tight">You Passed!</h2>
            <p class="text-slate-400 font-bold text-lg mb-10">You have successfully completed the quiz for <strong><%= cert.getCourseTitle() %></strong>.</p>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="<%= ctx %>/student/courses" class="btn-duo btn-duo-white px-10">Back to Courses</a>
            </div>
        ...
        <% } else { %>
            ...
            <h2 class="text-4xl font-black text-slate-800 mb-4 tracking-tight">Not Quite There</h2>
            <p class="text-slate-400 font-bold text-lg mb-10">You did not reach the passing score. Review your course materials and try the quiz again when you are ready.</p>
