...
<body class="cert-print p-4 sm:p-20 flex flex-col items-center">
    ...
    <div class="cert-container bg-white w-full max-w-[1000px] aspect-[1.414/1] shadow-2xl relative overflow-hidden cert-border p-20 flex flex-col items-center justify-between text-center">
        ...
        <div>
            ...
            <h3 class="text-xs font-black text-slate-400 uppercase tracking-[0.5em] mb-12">Certificate of Completion</h3>
        </div>

        <div>
            <p class="text-lg font-bold text-slate-500 mb-4">This is to certify that</p>
            <h1 class="text-6xl font-black text-slate-900 mb-8 tracking-tight"><%= cert.getStudentName() %></h1>
            <p class="text-lg font-bold text-slate-500 mb-12">has successfully completed the course</p>
