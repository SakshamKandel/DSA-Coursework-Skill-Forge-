...
<div class="p-10 space-y-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div class="bg-slate-900 p-10 rounded-[3rem] shadow-xl shadow-slate-900/10 flex flex-col justify-between group overflow-hidden relative">
            ...
            <div class="relative z-10">
                ...
                <p class="text-white font-bold text-lg leading-tight mb-8">Browse the catalog and enroll in a new course.</p>
            </div>
    ...
    <section>
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight">My Courses</h2>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50/50">
                            ...
                            <th class="px-10 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest text-right">Enrolled On</th>
                        </tr>
                    </thead>
