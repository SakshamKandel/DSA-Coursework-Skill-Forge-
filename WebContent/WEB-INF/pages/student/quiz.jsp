...
<div class="quiz-container p-2 sm:p-4 lg:p-10">
    ...
    <div class="mascot-bubble-container mt-8">
        ...
        <div class="speech-bubble">
            <p>Read each question carefully and pick the best answer.</p>
        </div>
    </div>

    <!-- Quiz progress bar and back button -->
    <div class="quiz-header">
            ...
            <div class="quiz-progress-outer">
                <div id="quizProgress" class="quiz-progress-inner"></div>
            </div>
...
<script>
    // Track how many questions there are and which one is currently shown
    window.totalSteps = <%= questions.size() %>;
    window.currentStep = 1;

    // Updates the progress bar, the counter and which button is visible
    function updateUI() {
