...
<div class="p-10">
    <div class="flex items-center justify-between mb-10">
        <div class="flex items-center gap-6">
            ...
            <div>
                <h2 class="text-3xl font-black text-slate-800 tracking-tight">Manage Students</h2>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        <th class="px-8 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest">Name</th>
                        <th class="px-8 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest">Contact</th>
