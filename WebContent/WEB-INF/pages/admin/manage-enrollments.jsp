...
<div class="p-10">
    <div class="flex items-center justify-between mb-10">
        <div>
            <h2 class="text-3xl font-black text-slate-800 tracking-tight">Manage Enrollments</h2>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        ...
                        <th class="px-8 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest">Course</th>
                        <th class="px-8 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest text-center">Progress</th>
                        <th class="px-8 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest text-center">Status</th>
                        <th class="px-8 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest text-right">Enrolled On</th>
                    </tr>
                </thead>
