...
<div class="p-10 space-y-12">
    ...
    <section>
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight">Recent Enrollments</h2>
                <p class="text-[0.7rem] font-black text-slate-400 uppercase tracking-widest mt-2">Latest student enrollments</p>
            </div>
            <a href="<%= ctx %>/admin/enrollments" class="text-xs font-black text-brand uppercase tracking-widest hover:underline underline-offset-8 decoration-2 decoration-brand/30">View All</a>
        </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50/50">
                            ...
                            <th class="px-10 py-6 text-[0.7rem] font-black text-slate-400 uppercase tracking-widest text-right">Date</th>
                        </tr>
                    </thead>
