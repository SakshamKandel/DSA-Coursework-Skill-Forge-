...
<div class="auth-container">
    <div class="auth-card">
        ...
        <p class="subtitle subtitle-gap">We will help you reset it.</p>
        ...
        <% if (request.getAttribute("step") == null) { %>
            <!-- Step 1: ask the user for their account email -->
        ...
        <% } else if ("reset".equals(request.getAttribute("step"))) { %>
            <!-- Step 2: token plus new password -->
            <form action="<%= ctx %>/forgot-password" method="post" class="form-left-align">
                ...
                <div class="field">
                    <p class="subtitle reset-info-text">
                        Resetting password for: <strong><%= request.getAttribute("email") != null ? request.getAttribute("email") : (session.getAttribute("resetEmail") != null ? session.getAttribute("resetEmail") : "Email not provided") %></strong>
                    </p>
                    ...
                    <p class="subtitle token-hint">Your reset token: <%= request.getAttribute("token") %></p>
                </div>
